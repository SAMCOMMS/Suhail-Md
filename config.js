...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "2349112040503,2348123997976";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "©`SAMCOMMS_INTERNET_SERVICES`" , // ```『 POWERED BY SAMCOMMS__BOT__ 😎 』```", //*『SAMCOMMS__BOT__』*\n https://wa.me/message/6KY2PBZF4YC3E1"),
  ...
  errorChat : process.env.ERROR_CHAT || "error oo 😂🤲",
  KOYEB_API : process.||  REMOVE_BG_KEY : process.env.REMOVE_BG_KEY  || "",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "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",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "HRKU-6ba9a88a-eb21-4a89-8576-812dfad03e3a",
  HEROKU_APP_NAME:process.env.HEROKU_APP_NAME|| "samcommsbot",
  antilink_values:process.env.ANTILINK_VALUES|| "all",
  HEROKU: process.env.HEROKU_APP_NAME && process.env.HEROKU_API_KEY,

  aitts_Voice_Id : process.env.AITTS_ID || "37",
  ELEVENLAB_API_KEY: process.env.ELEVENLAB_API_KEY  || "9ba1e53d96131da524e8bf4f7c8ca6a3",
